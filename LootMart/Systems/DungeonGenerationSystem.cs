...
{
    public static class DungeonGenerationSystem
    {
        public static DungeonTile[,] GenerateDungeon(int worldMin, int worldMax)
        {
            int worldI = Constants.Random.Next(worldMin, worldMax);
            int worldJ = Constants.Random.Next(worldMin, worldMax);
            DungeonTile[,] dungeonGrid = new DungeonTile[worldI, worldJ];
            ...
            while (!acceptable)
            {
                ...
                for (int i = 0; i < worldI; i++)
                {
                    ...
                    {
                        int choice = Constants.Random.Next(0, 101);
                ...
                for (int z = 0; z <= iterations; z++)
                {
                    ...
                    for (int i = 0; i < worldI; i++)
                    {
                        for (int j = 0; j < worldJ; j++)
                        {
                            ...
                            if (numRocks >= 5 || i == 0 || j == 0 || i == worldI - 1 || j == worldJ - 1 || (z <= 1 && numRocks + farRocks <= 2))
                            {
                ...
                do
                {
                    fillX = Constants.Random.Next(0, worldI);
                    fillY = Constants.Random.Next(0, worldJ);
        ...
        private static void FloodFill(int x, int y, int worldI, int worldJ, ref DungeonTile[,] dungeonGrid)
        {
